...
let serverURL = "remote-text-editor.herokuapp.com";
let caretPosition;
...
$(document).ready(function () {
    ...
    window.setInterval(function () {
            if (!docChanged && $("#selectDoc").val() !== null) {
                setCaretPosition($("#textarea").getCaretPosition());
                $.ajax({
                        url: "https://" + serverURL + "/docs/" + $("#selectDoc").val(),
                        method: "post",
            ...
            setTimeout(function () {
                if (docChanged && $("#selectDoc").val() !== null) {
                    ...
                    $.ajax({
                        url: "https://" + serverURL + "/docs/" + $("#selectDoc").val() + "/update",
                        method: "post",
                        crossDomain: true,
